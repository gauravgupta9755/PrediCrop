...
dtr=pickle.load(open('dtr.pkl','rb'),encoding="ASCII")
...
def crop_prediction():
    title = 'PrediCrop - Crop Recommendation'
    if request.method=='POST':
            ...
            return render_template('crop-result.html', predicted_values=predicted_values)
